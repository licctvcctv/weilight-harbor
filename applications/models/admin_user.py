...
class User(db.Model, UserMixin):
    ...
    phone = db.Column(db.String(20), comment='Phone number')
    email = db.Column(db.String(120), comment='Email')
    bio = db.Column(db.String(500), comment='Bio')
    user_type = db.Column(db.String(20), default='regular', comment='User type: regular/certified_family/certified_volunteer/admin')
    is_certified = db.Column(db.Boolean, default=False, comment='Whether certified')
    locale = db.Column(db.String(5), default='en', comment='Language preference')
