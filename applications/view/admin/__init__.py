...
from applications.view.admin.certification_review import admin_cert
from applications.view.admin.campaign_review import admin_campaign
from applications.view.admin.community_moderation import admin_community
...
def register_admin_views(app: Flask):
    ...
    app.register_blueprint(admin_cert)
    app.register_blueprint(admin_campaign)
    app.register_blueprint(admin_community)
